...
#define _Pi                             3.14159265359
    ...
    #define _MAX_ERREUR_INTEGRALLE_V     10000. //7500 pas bon //4500.
    ...
    /****************************** ODOMETRIE *********************************/
    /**************************************************************************/
    #define _ENTRAXE_MM                178.// //Pas assez tourné -> augmenter entraxe
    #define _DIAMETRE_ROUE_CODEUSE       56//  //Toujours dans le sens de l'erreur : aller plus loin = diminuer D
    #define _PERIMETRE_ROUE_MM           217. //Si distance parcourue trop grande -> Augmenter la taille des roues
  

    #define  _COEF_D                    (double) 1.0//1.0017 VIN //  //1.00372     1.004 gauche x=1.003  1.0025droite //augmente = + devie a gauche
    //+COEF_D -> + a droite
    ...
    //PID
    #define _VITESSE_DIS_KP   0.5//0.5//0.25  VINCENT     //0.8 //1. //0.8 //1.5 //0.8 
    #define _VITESSE_DIS_KI   0.005 // 0.005//0.0005 vin //0.08//0.082 //0.13 //0.3 //0.1 //0.05 //0.02 //0.045
    ...
    #define KP_BRAKE                    0.01     //0.04      OSSILE    //0.04 VIN//0.03//0.09//0.058//0.04 // fait avec vincent le 16 AVRIL 2023
    #define KI_BRAKE                    0.00005  //0.0005    OSSILE    //0.0005 VIN//0.0015
    #define KD_BRAKE                    0.3      ///0.6      OSSILE    //0.2 //0.00333 //1.2 //0.8
    ...
    #define _CODEUR_D_NB_IMP             5000U
    #define _CODEUR_G_NB_IMP             5000U
