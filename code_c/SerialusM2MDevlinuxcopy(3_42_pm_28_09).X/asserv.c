...
/**
 * Fonction qui initialise les flag de l'asserv pour démarer l'asserv f avada
 */
 ...
 * @brief FOnction qui calcul les accélérations et décélérations pour construire la rampe de vitesse
