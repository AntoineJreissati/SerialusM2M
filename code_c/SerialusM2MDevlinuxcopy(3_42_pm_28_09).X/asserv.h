...
extern double MAX_ERREUR_INTEGRALLE_V;
extern double MAX_E_INTEGRALLE_BRAKE;
...
extern double ENTRAXE_MM;               
extern double DIAMETRE_ROUE_CODEUSE;
extern double PERIMETRE_ROUE_MM;

extern double COEF_D;
extern double COEF_G;


extern double MM_PAR_TICKS;
extern double TICKS_PAR_MM;
extern double ENTRAXE_TICKS;
...
extern double SEUIL_IMMOBILITE;

#define CONSIGNE_MAX                100.

    //Association Distance - Vitesse - Accélérations Max
extern double VITESSE_CONSIGNE_MAX_MM;
extern double VITESSE_DISTANCE_MIN;
extern double VITESSE_MAX_MM_TENSION;

extern double VITESSE_CONSIGNE_MAX_PAS;
extern double VITESSE_DISTANCE_MIN_PAS;
extern double VITESSE_MAX_TENSION;

extern double DISTANCE_CONSIGNE_MM;

extern double DISTANCE_CONSIGNE_PAS;
//#define DISTANCE_CONSIGNE_PAS       ( DISTANCE_CONSIGNE_MM * TICKS_PAR_MM )

extern double ACC_POSITION_CONSIGNE;
extern double DCC_POSITION_CONSIGNE;
extern double ACC_POSITION_MIN;
extern double DCC_POSITION_MIN;


extern double COEF_FREINAGE;

    //Association Orientation - Vitesse - Accélération Max
extern double VITESSE_ANGLE_MAX;
extern double VITESSE_ANGLE_MIN;
extern double VITESSE_ANGLE_PAS;
extern double VITESSE_ANGLE_MIN_PAS;

extern double ORIENTATION_CONSIGNE_DEG;
extern double ORIENTATION_CONSIGNE_PAS;
...
extern double ACC_ORIENTATION_CONSIGNE;
extern double DCC_ORIENTATION_CONSIGNE;
extern double ACC_ORIENTATION_MIN;
extern double DCC_ORIENTATION_MIN;
